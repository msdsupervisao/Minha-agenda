...
6. Confirme **Agendar no celular** e aceite a abertura do aplicativo.

No horário, a notificação mostra apenas um aviso genérico. Ao tocá-la, o texto é
entregue ao WhatsApp; o usuário ainda escolhe o grupo e confirma o envio.
